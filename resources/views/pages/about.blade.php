...
<x-layouts.page 
    title="{{ config('site.title') }} - About us" 
...
>
    ...
    >
        {{-- Parallax image --}}
        <div class="bg-about-hero-pattern parallax-bg absolute inset-0 w-full h-full max-h-[60%] -z-10 bg-cover bg-center bg-no-repeat"></div>

        <div class="max-w-mincontainer mx-auto px-10 pt-44 md:pt-80 pb-20 md:pb-32">
    ...
    <section class="max-w-mincontainer mx-auto px-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-32">
        <div class="relative">
            ...
            <img 
                ...
                class="absolute right-0 -top-24 md:-top-24 w-40 md:w-64"
                data-scroll 
