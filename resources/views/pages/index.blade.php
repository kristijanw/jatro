<x-layouts.page title="{{ config('site.title') }}" description="{{ config('site.description') }}">
    ...
    <section id="hero" aria-labelledby="home page hero" class="object-cover bg-no-repeat bg-right-top" x-data="{ progress: 0, interval: null }" x-init="() => { 
        ...
        {{-- Parallax image --}}
        <div class="bg-hero-pattern parallax-bg w-full h-screen pt-64 bg-cover bg-center bg-no-repeat relative">
            ...
            <div class="max-w-maxcontainer mx-auto px-10 relative">
                ...
                <div class="flex items-center gap-32">
                    ...
                    <div class="relative h-1 bg-gray-200 rounded-full max-w-[592px] w-full">
                        <div x-bind:style="'width: ' + progress + '%;'" class="absolute top-0 left-0 h-full bg-[#085499] rounded-full transition-all"></div>
                    </div>
                </div>
