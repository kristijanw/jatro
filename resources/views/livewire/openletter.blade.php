            ...
            <form wire:submit="add" class="flex flex-col gap-4">
                ...
                <label class="flex flex-col gap-2 text-black">
                    <input 
                        ...
                        class="px-3 py-2 border placeholder:text-[#FCFCFC] font-normal rounded-lg border-[#0A6FB8] bg-transparent read-only:opacity-50 read-only:cursor-not-allowed">
                ...
                <label>
                    <div class="text-sm flex items-center gap-2">
                        <input wire:model="form.terms" type="checkbox" class="!rounded !bg-transparent !text-[#00BAF0] !border-[#00BAF0]">
                ...
                <x-dialog.footer>
                    <button type="submit" class="text-center rounded bg-[#00BAF0] text-[#FCFCFC] px-6 py-2 font-semibold disabled:cursor-not-allowed disabled:opacity-50">
                        Send
                    </button>
                </x-dialog.footer>
            </form>
