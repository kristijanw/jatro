            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-slate-200/10 dark:divide-slate-700/10">
                    <div class="space-y-2 py-6">
                        <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 hover:bg-slate-200 dark:hover:bg-slate-700">Services & Projects</a>
                        <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 hover:bg-slate-200 dark:hover:bg-slate-700">About us</a>
                        <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 hover:bg-slate-200 dark:hover:bg-slate-700">News</a>
                        <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 hover:bg-slate-200 dark:hover:bg-slate-700">Contact</a>
                    </div>
